...
Vue.use(Vuex);
```
	* 전역 스크립트 태그를 사용할 때는 이 작업을 할 필요가 없다
...
<img width="401" alt="vue structure" src="https://user-images.githubusercontent.com/39546874/49573936-8c514080-f982-11e8-9200-5161543a1f6c.png">
...
> => 단방향 데이터 흐름을 활용해 뷰 컴포넌트를 구성하는 React를 보완하는 역할Redux  
> => JavaScript 어플리케이션에서 data-state 와 UI-state 를 관리해주는 도구The Elm Architecture  
...
<img width="643" alt="vuex structure" src="https://user-images.githubusercontent.com/39546874/49573978-a25f0100-f982-11e8-9b16-7373d011badd.png">
...
> 글로벌 이벤트 버스  
> => 비 부모-자식간 통신에서 사용  
> 비어있는 Vue 인스턴스를 중앙 이벤트 버스로 사용한다```javascript  
 글로벌 버스 이벤트
